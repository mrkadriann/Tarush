...
fun TarushApp() {
    ...
    val productList = remember {
        listOf(
            Product("1", "WATSONS Cetirizine 10mg Tablet", 16, R.drawable.product_cetrizine, "Biñan City, Laguna", 10000, "WATSONS OFFICIAL STORE", R.drawable.icon_watsons, "WATSONS", R.drawable.icon_watsons, "These tablets effectively alleviate allergy symptoms. They provide relief from minor allergies and are effective within a short period. This product has an extended shelf life."),
            Product("2", "Lucky Me! Pancit Canton", 109, R.drawable.product_pancit_kanton, "Quezon City", 9800, "", null, "LUCKY ME", null, "Popular instant noodles with a rich flavor. Ready in minutes and perfect for a quick meal."),
            ...
            Product("4", "Adidas Running Galaxy 6 Shoes Blue", 2400, R.drawable.product_shoes, "Makati", 10000, "", null, "ADIDAS", null, "Premium running shoes with excellent cushioning and support. Designed for comfort during long runs.")
        )
    }
